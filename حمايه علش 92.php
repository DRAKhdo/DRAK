<?php
ob_start();
$DRAK = '1915518018:AAFZRh8gzvRv3CbWL5VWv57btUf4DjyACJc';
define('DRAK',$DRAK);
echo file_get_contents("https://api.telegram.org/bot" . DRAK . "/setwebhook?url=" . $_SERVER ['SERVER_NAME'] . "" . $_SERVER['SCRIPT_NAME']);
            function bot($method,$datas=[]){
    $rembo = http_build_query($datas);
        $url = "https://api.telegram.org/bot".DRAK."/".$method."?$rembo";
        $h4ck3riraq = file_get_contents($url);
        return json_decode($h4ck3riraq);
}
$bot_id = "@gkdgdjBOT"; // ايدي بوتك
$admmm = "@AUJLJI";
$hskddb = "XTXTB"; 
$Dev = array("$admmm","000");// حط ايدي مطور ثاني بدل الاصفار
@$channel = "hskddb";
@$token = DRAK;
$buyy = "@hskddb";
...
$idBot = $bot_id;
$infos = json_decode(file_get_contents("https://api.telegram.org/bot".DRAK."/getChatMember?chat_id=$chat_id&user_id=$idBot"), true);
...
$a = json_decode(file_get_contents("https://api.telegram.org/bot".DRAK."/getuserprofilephotos?user_id=".$from_id));
$b = objectToArrays($a);
$c = $b["ok"];
$d = $b["result"];
$e = $d["total_count"];
...
$a = json_decode(file_get_contents("https://api.telegram.org/bot".DRAK."/getuserprofilephotos?user_id=".$n));
$b = objectToArrays($a);
$c = $b["ok"];
$d = $b["result"];
$e = $d["total_count"];
...
$a = json_decode(file_get_contents("https://api.telegram.org/bot".DRAK."/getuserprofilephotos?user_id=".$re_id));
$b = objectToArrays($a);
$c = $b["ok"];
$d = $b["result"];
$e = $d["total_count"];
...
ادخل للقناة لتتعلم اكثر » @hskddb
",
...
'disable_web_page_preview'=>true,
        ...
        'reply_markup'=>json_encode([
          'inline_keyboard'=>[  
                [['text'=>'• اصنع بوت ، لك 🔱','url'=>'https://t.me/hskddb']],
               ]
        ])
    ]);
}
...
$re_id      = $update->message->reply_to_message->from->id;
$DRAK = DRAK;
$get = file_get_contents("https://api.telegram.org/bot$DRAK/getChatMember?chat_id=$chat_id&user_id=".$re_id);
...
$get             = file_get_contents("https://api.telegram.org/bot$DRAK/getChatMember?chat_id=$chat_id&user_id=".$from_id);
$info            = json_decode($get, true);
...
$result=json_decode(file_get_contents("https://api.telegram.org/bot".DRAK."/getUserProfilePhotos?user_id=$from_id"),true);
...
$Q9LLE = "1890844234";//هنا ايديك
$TTK       = $message->message_id;
$Kickmetxt = file_get_contents("kickme.txt");
if ($text =="اطردني" or $text == "ادفرني" or $text == "مغادره" and $from_id != $Q9LLE){
...
if ($text =="اطردني" and $from_id == $Q9LLE){
 bot("sendMessage",[
 "chat_id"=>$chat_id,
 "text"=>"
• لااستطيع طردك مطوري •
